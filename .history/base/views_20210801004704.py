...
def home(request):
    ...
    endorsement = Endorsement.objects.filter(featured=True)
    form = MessageForm()
    ...
    context = {'projects': projects, 'skills': skills, 'detailedSkills':detailedSkills, 'form': form, 'endorsement': endorsement}
